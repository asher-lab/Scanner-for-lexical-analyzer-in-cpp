...
tk_Integer, tk_String, tk_DataType = range(32)

nd_Ident, nd_String, nd_Integer, nd_Sequence, nd_If, nd_Prtc, nd_Prts, nd_Prti, nd_While, \
nd_Assign, nd_Negate, nd_Not, nd_Mul, nd_Div, nd_Mod, nd_Add, nd_Sub, nd_Lss, nd_Leq, \
nd_Gtr, nd_Geq, nd_Eql, nd_Neq, nd_And, nd_Or, nd_DataType = range(26)
...
Tokens = [
    ...
    [";", False, False, False, -1, -1],
    [",", False, False, False, -1, -1],
    ["DataType", False, False, False, -1, nd_DataType],
...
all_syms = {"End_of_input": tk_EOI, "Op_multiply": tk_Mul,
            ...
            "String": tk_String, "DataType": tk_DataType}
...
def gettok():
    ...
    if tok == None:
        error(": LINE NUMBER  < == >  INVALID TOKEN = '%s'" % (tok_text))
    tok_other = None
...
def stmt():
    ...
    if tok == tk_If:
        ...
        expect("NOT CLOSED LEFT BRACE", tk_Rbrace)

    elif tok == tk_EOI:
        pass

    elif tok == tk_DataType:
        gettok()
    else:
...
if(prt_ast(t)):
    print("SYNTAX CHECKING SUCCESSFUL\n")
